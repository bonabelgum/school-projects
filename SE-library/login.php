        ...
        <div class="container">
          <div class="col-lg-4 col-md-6 col-sm-6 ml-auto mr-auto">
            <form class="form" method="POST" action="login_verify.php">
              <div class="card card-login glass-login">
                <div class="card-body">

                  <!-- AVATAR INSIDE WHITE CARD -->
            ...
            <form>
              <script src="https://checkout.razorpay.com/v1/payment-button.js"
                      data-payment_button_id="pl_GffqOJ4TsFX8hN" async>
              </script>
            </form> -->
          ...
          <div class="container">
            <center>
              <span style="font-size: small;">
                &copy; 2025 MC LIBRARIES |
                <a href="https://mabinicolleges.edu.ph" target="_right">
                  Mabini College, Inc.
                </a>
              </span>
            </center>
